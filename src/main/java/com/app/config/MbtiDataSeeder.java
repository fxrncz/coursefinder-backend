...
public class MbtiDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("Seeding MBTI data...");
        
        try {
            // Load and execute the SQL file
            ClassPathResource resource = new ClassPathResource("data/mbti_riasec_mappings.sql");
            ...
            System.out.println("Successfully seeded " + newCount + " MBTI records");
            
        } catch (IOException e) {
            System.err.println("Failed to load MBTI data file: " + e.getMessage());
        } catch (Exception e) {
            System.err.println("Failed to seed MBTI data: " + e.getMessage());
        }
    }
}
